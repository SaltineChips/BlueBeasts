...
Section -post SEC0001
    ...
    #    WriteRegStr HKCR "bitcoin" "" "URL:BlueBeastsCoin"
    #    WriteRegStr HKCR "bitcoin\DefaultIcon" "" $INSTDIR\bitcoin-qt.exe
    #    WriteRegStr HKCR "bitcoin\BlueBeasts-Coin\open\command" "" '"$INSTDIR\bitcoin-qt.exe" "$$1"'
SectionEnd
...
Section -un.post UNSEC0001
    ...
    #Delete /REBOOTOK "$SMPROGRAMS\$StartMenuGroup\BlueBeastsCoin.lnk"
    #Delete /REBOOTOK "$SMSTARTUP\BlueBeastsCoin.lnk"
