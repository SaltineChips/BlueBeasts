    ...
    if(fMasterNode) {
        ...
        BOOST_FOREACH(const CTransaction& txCollateral, vecSessionCollateral) {
            ...
            /*
                ...
                allow endless transaction that would bloat BlueBeasts-Coin and make it unusable. To
                stop these kinds of attacks 1 in 50 successful transactions are charged. This
                adds up to a cost of 0.002 TBB per transaction on average.
            */
            if(r <= 10)
            {
...
void ThreadCheckMNenginePool()
{
    ...
    RenameThread("BlueBeasts-Coin-mnengine");
