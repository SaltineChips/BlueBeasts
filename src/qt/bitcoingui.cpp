 ...
 * The BlueBeastsCoin Developers 2018-2019
 */
...
BlueBeastsCoinGUI::BlueBeastsCoinGUI(QWidget *parent):
    QMainWindow(parent),
    clientModel(0),
    walletModel(0),
    toolbar(0),
...
{
    resize(900, 520);
    setWindowTitle(tr("BlueBeasts-Coin") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
#endif
    setObjectName("BlueBeasts-Coin");
    setStyleSheet("#BlueBeasts-Coin { background-color: #ffffff; color: #4c5259;}");
...
BlueBeastsCoinGUI::~BlueBeastsCoinGUI()
{
...
void BlueBeastsCoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a BlueBeasts-Coin address"));
    ...
    aboutAction = new QAction(QIcon(":icons/bluebeasts-coin"), tr("&About BlueBeasts-Coin"), this);
    aboutAction->setToolTip(tr("Show information about BlueBeasts-Coin"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/qt-project.org/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for BlueBeasts-Coin"));
    ...
    editConfigAction = new QAction(QIcon(":/icons/editconf"), tr("&Edit BlueBeasts-Coin.conf"), this);
    editConfigAction->setToolTip(tr("Edit the configuration file for BlueBeasts-Coin"));
    editConfigExtAction = new QAction(QIcon(":/icons/editconf"), tr("&Edit BlueBeasts-Coin.conf (external)"), this);
    editConfigExtAction->setToolTip(tr("Edit the configuration file for BlueBeasts-Coin (external editor)"));
    openDataDirAction = new QAction(QIcon(":/icons/folder"), tr("&Open data dir"), this);
    openDataDirAction->setToolTip(tr("Open the directory where BlueBeasts-Coin data is stored"));
...
void BlueBeastsCoinGUI::createMenuBar()
{
#ifdef Q_OS_MAC
...
void BlueBeastsCoinGUI::createToolBars()
{
...
void BlueBeastsCoinGUI::setClientModel(ClientModel *clientModel)
{
    if(!fOnlyTor)
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("BlueBeasts-Coin client") + QString(" ") + tr("[testnet]"));
...
void BlueBeastsCoinGUI::setWalletModel(WalletModel *walletModel)
{
...
void BlueBeastsCoinGUI::createTrayIcon()
{
    QMenu *trayIconMenu;
#ifndef Q_OS_MAC
    ...
    trayIcon->setToolTip(tr("BlueBeasts-Coin client"));
...
#ifndef Q_OS_MAC
void BlueBeastsCoinGUI::trayIconActivated(QSystemTrayIcon::ActivationReason reason)
{
...
void BlueBeastsCoinGUI::optionsClicked()
{
...
void BlueBeastsCoinGUI::aboutClicked()
{
    AboutDialog dlg;
...
void BlueBeastsCoinGUI::setNumConnections(int count)
{
    QString icon;
    switch(count)
    {
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to BlueBeasts-Coin network", "", count));
}

void BlueBeastsCoinGUI::setNumBlocks(int count)
{
    QString tooltip;
...
void BlueBeastsCoinGUI::message(const QString &title, const QString &message, bool modal, unsigned int style)
{
    QString strTitle = tr("BlueBeasts-Coin") + " - ";
...
void BlueBeastsCoinGUI::error(const QString &title, const QString &message, bool modal)
{
...
void BlueBeastsCoinGUI::changeEvent(QEvent *e)
{
...
void BlueBeastsCoinGUI::closeEvent(QCloseEvent *event)
{
    if(clientModel)
    {
#ifndef Q_OS_MAC // Ignored on Mac
...
void BlueBeastsCoinGUI::askFee(qint64 nFeeRequired, bool *payFee)
{
    if (!clientModel || !clientModel->getOptionsModel())
        return;
    ...
    QString strMessage = tr("This transaction is over the size limit. You can still send it for a fee of %1, "
        ...
        "Do you want to pay the fee?").arg(BlueBeastsCoinUnits::formatWithUnit(clientModel->getOptionsModel()->getDisplayUnit(), nFeeRequired));
...
void BlueBeastsCoinGUI::incomingTransaction(const QModelIndex & parent, int start, int end)
{
    ...
    notificator->notify(Notificator::Information,
                        (amount)<0 ? tr("Sent transaction") :
                          ...
                          tr("Date: %1\n"
                             ...
                             "Address: %4\n")
                          .arg(date)
                          .arg(BlueBeastsCoinUnits::formatWithUnit(walletModel->getOptionsModel()->getDisplayUnit(), amount, true))
                          .arg(type)
                          .arg(address), icon);
}

void BlueBeastsCoinGUI::clearWidgets()
{
...
void BlueBeastsCoinGUI::gotoMasternodeManagerPage()
{
...
void BlueBeastsCoinGUI::gotoBlockBrowser()
{
...
void BlueBeastsCoinGUI::gotoOverviewPage()
{
...
void BlueBeastsCoinGUI::gotoHistoryPage()
{
...
void BlueBeastsCoinGUI::gotoAddressBookPage()
{
...
void BlueBeastsCoinGUI::gotoReceiveCoinsPage()
{
...
void BlueBeastsCoinGUI::gotoSendCoinsPage()
{
...
void BlueBeastsCoinGUI::gotoSignMessageTab(QString addr)
{
...
void BlueBeastsCoinGUI::gotoVerifyMessageTab(QString addr)
{
...
void BlueBeastsCoinGUI::dragEnterEvent(QDragEnterEvent *event)
{
    // Accept only URIs
...
void BlueBeastsCoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid BlueBeasts-Coin address or malformed URI parameters."));
    }

    event->acceptProposedAction();
}

void BlueBeastsCoinGUI::handleURI(QString strURI)
{
    // URI has to be valid
...
void BlueBeastsCoinGUI::setEncryptionStatus(int status)
{
...
void BlueBeastsCoinGUI::encryptWallet()
{
    if(!walletModel)
        return;
...
void BlueBeastsCoinGUI::backupWallet()
{
...
void BlueBeastsCoinGUI::importPrivateKey()
{
...
void BlueBeastsCoinGUI::changePassphrase()
{
...
void BlueBeastsCoinGUI::unlockWallet()
{
    if(!walletModel)
        return;
...
void BlueBeastsCoinGUI::lockWallet()
{
    if(!walletModel)
        return;
...
void BlueBeastsCoinGUI::showNormalIfMinimized(bool fToggleHidden)
{
...
void BlueBeastsCoinGUI::toggleHidden()
{
    showNormalIfMinimized(true);
}

void BlueBeastsCoinGUI::updateWeight()
{
    if (!pwalletMain)
        return;
...
void BlueBeastsCoinGUI::updateStakingIcon()
{
    updateWeight();
...
void BlueBeastsCoinGUI::detectShutdown()
{
    if (ShutdownRequested())
        QMetaObject::invokeMethod(QCoreApplication::instance(), "quit", Qt::QueuedConnection);
}

void BlueBeastsCoinGUI::showProgress(const QString &title, int nProgress)
{
    if (nProgress == 0)
    {
...
void BlueBeastsCoinGUI::editConfig()
{
...
void BlueBeastsCoinGUI::editConfigExt()
{
...
void BlueBeastsCoinGUI::openDataDir()
{
