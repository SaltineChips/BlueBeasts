...
{
    columns << QString() <<  QString() << tr("Date") << tr("Type") << tr("Address") << BlueBeastsCoinUnits::getAmountColumnTitle(walletModel->getOptionsModel()->getDisplayUnit());
...
{
	columns[Amount] = BlueBeastsCoinUnits::getAmountColumnTitle(walletModel->getOptionsModel()->getDisplayUnit());
...
{
    QString str = BlueBeastsCoinUnits::format(walletModel->getOptionsModel()->getDisplayUnit(), wtx->credit + wtx->debit);
    if(showUnconfirmed)
    {
