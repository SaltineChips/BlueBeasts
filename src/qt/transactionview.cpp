...
void TransactionView::changedAmount(const QString &amount)
{
    ...
    // Replace "," by "." so BlueBeastsCoinUnits::parse will not fail for users entering "," as decimal separator
    QString newAmount = amount;
    newAmount.replace(QString(","), QString("."));

    if(BlueBeastsCoinUnits::parse(model->getOptionsModel()->getDisplayUnit(), newAmount, &amount_parsed))
    {
...
void TransactionView::exportClicked()
{
    ...
    writer.addColumn(BlueBeastsCoinUnits::getAmountColumnTitle(model->getOptionsModel()->getDisplayUnit()), 0, TransactionTableModel::FormattedAmountRole);
...
void TransactionView::computeSum()
{
    ...
    QString strAmount(BlueBeastsCoinUnits::formatWithUnit(nDisplayUnit, amount, true, BlueBeastsCoinUnits::separatorAlways));
