...
/** BlueBeastsCoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class BlueBeastsCoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit BlueBeastsCoinUnits(QObject *parent);

    /** BlueBeastsCoin units.
...
typedef BlueBeastsCoinUnits::Unit BlueBeastsCoinUnit;
