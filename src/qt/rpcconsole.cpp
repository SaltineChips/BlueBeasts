...
/**
 * Split BlueBeasts-Coin command line into a list of arguments. Aims to emulate \c bash and friends.
 *
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the BlueBeasts-Coin RPC console.") + "<br>" +
