...
/**
  BlueBeastsCoin GUI main class. This class represents the main window of the BlueBeastsCoin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class BlueBeastsCoinGUI : public QMainWindow
{
    Q_OBJECT

public:
    explicit BlueBeastsCoinGUI(QWidget *parent = 0);
    ~BlueBeastsCoinGUI();
...
private slots:
    ...
    */
    ...
    /** Edit the BlueBeasts-Coin.conf file */
    void editConfig();
    void editConfigExt();
