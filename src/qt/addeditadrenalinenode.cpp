    ...
    ui(new Ui::AddEditAdrenalineNode)
{
    ...
    ui->txhashLineEdit->setPlaceholderText("Enter your 65,000 TBB TXID");
...
void AddEditAdrenalineNode::on_okButton_clicked()
{
    ...
    {
        QMessageBox msg;
        msg.setText("Please enter the transaction hash for the transaction that has 65,000 coins");
        msg.exec();
        return;
    }
