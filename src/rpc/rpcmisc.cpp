...
Value validateaddress(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "validateaddress <BlueBeasts-Coin>\n"
            "Return information about <BlueBeasts-Coin>.");
...
Value validatepubkey(const Array& params, bool fHelp)
{
    if (fHelp || !params.size() || params.size() > 2)
        throw runtime_error(
            "validatepubkey <BlueBeasts-Coinpubkey>\n"
            "Return information about <BlueBeasts-Coinpubkey>.");
...
Value verifymessage(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            "verifymessage <BlueBeasts-Coin> <signature> <message>\n"
